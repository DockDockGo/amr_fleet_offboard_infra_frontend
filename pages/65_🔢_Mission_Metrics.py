...
# Streamlit interface
st.title("AMR Mission Metrics Dashboard")
...
st.markdown("A mission is defined as the act of an AMR undocking from its current location, navigating to a goal location, and docking at the goal location.")

st.markdown("## List of Missions")
